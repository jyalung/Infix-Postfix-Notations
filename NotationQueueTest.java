...
public class NotationQueueTest {
	...
	public double first = 1.0, second = 2.0, third = 3.0;
	...
	public void testDequeueStudent() {
		try {
			assertEquals(Double.valueOf(first), doubleQ.dequeue());
			assertEquals(Double.valueOf(second), doubleQ.dequeue());
			assertEquals(Double.valueOf(third), doubleQ.dequeue());
